  ...
  return (
    <>
      ...
      <button
        ...
        aria-label="퀵 네비게이션"
        className={`fixed w-11 h-11 rounded-full border-2 shadow-lg active:scale-95 transition-all z-[55] flex items-center justify-center cursor-pointer hover:scale-105 backdrop-blur-md ${
          open ? "border-amber-600 text-white" : "border-amber-600 text-amber-600"
        }`}
        style={{
          ...FAB_POS[pos],
          backgroundColor: open ? "rgba(184, 134, 11, 0.85)" : "rgba(255, 255, 255, 0.6)",
        }}
      >
      ...
      {open && (
        <>
          ...
          <div
            className="z-[60] flex backdrop-blur-md border border-gray-300 dark:border-gray-600 rounded-lg shadow-2xl overflow-hidden"
            style={{ ...PANEL_POS, backgroundColor: "rgba(255, 255, 255, 0.65)" }}
