          ...
          <div className="max-w-2xl mx-auto p-4 md:p-8 w-full">
            <div className="relative mb-6">
              <input
                ...
                className={`w-full pl-12 pr-4 py-4 rounded-2xl text-lg outline-none border focus:border-[var(--amber)] focus:ring-1 focus:ring-[var(--amber)] transition-shadow ${inputClass}`}
              />
